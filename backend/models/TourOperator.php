...
/**
 * This is the model class for table "tour_operator".
 *
 * @property int $id
 ...
 */
class TourOperator extends \backend\models\BaseModel
{
    use BaseModelTrait;
    ...
    {
        return $this->hasMany(TourPackage::className(), ['tour_operator_id' => 'id']);
    }
}
